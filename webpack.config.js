...
module.exports = {
  ...
  "entry": {
    ...
    "styles": [
      "./src/styles.css",
      "./src/css/superhero-bootstrap.min.css",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "src/css/superhero-bootstrap.min.css"),
          path.join(process.cwd(), "node_modules/ngx-bootstrap/datepicker/bs-datepicker.scss")
        ],
        "test": /\.css$/,
        "use": [
          {
